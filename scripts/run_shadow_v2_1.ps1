# Session-proof launcher for the v2.1 portfolio shadow bot (tcn_v2_1 lock:
# per-member Platt calibration + EV-proportional sizing).
# Registered as scheduled task BTCResearch_ShadowV2_1. Capture OFF (v1 archives feeds).
...
$env:TCN_STRATEGY_LOCK = 'artifacts\strategy_locks\tcn_v2_1_lock.json'
...
& python -m live_bot.tcn_shadow_bot `
    --decisions-dir logs\tcn_v2_1_shadow --log-level INFO `
    *>> logs\tcn_v2_1_shadow\runner.log
