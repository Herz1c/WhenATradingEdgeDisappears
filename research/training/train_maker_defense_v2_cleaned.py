...
# This is a cleaned-feature variant of train_maker_defense_v2.py.
...
try:
    ALL_FEATURES_V2 = _cfl(ALL_FEATURES_V2, include_bucket=False)
except NameError:
    pass
try:
    EXTRA_FEATURES = _cfl(EXTRA_FEATURES, include_bucket=False)
except NameError:
    pass
# ==============================================
...
if __name__ == "__main__":
    ...
    out_root = Path("artifacts_cleaned/model_08c_maker_defense_v2")
    ...
    print("#"*72)
    v1_dir = Path("artifacts_cleaned/model_08c_maker_defense")
