...
FEAT_49 = json.loads(
    Path("artifacts/model_08b_big_move_classifier/tabular_btc/lightgbm/results.json").read_text()
)["config"]["features"]
...
REF_AUC = {
    ...
    "08c_v1/severe_7c_3s":         json.loads(Path("artifacts/model_08c_maker_defense/severe_7c_3s/metrics.json").read_text()).get("auc_test"),
    "08c_v1/moderate_5c_5s":       json.loads(Path("artifacts/model_08c_maker_defense/moderate_5c_5s/metrics.json").read_text()).get("auc_test"),
    "08c_v2/extreme_10c_5s":       json.loads(Path("artifacts/model_08c_maker_defense_v2/extreme_10c_5s/metrics.json").read_text()).get("auc_test"),
    "08c_v2/severe_7c_3s":         json.loads(Path("artifacts/model_08c_maker_defense_v2/severe_7c_3s/metrics.json").read_text()).get("auc_test"),
    "08c_v2/moderate_5c_5s":       json.loads(Path("artifacts/model_08c_maker_defense_v2/moderate_5c_5s/metrics.json").read_text()).get("auc_test"),
    "08c_v3_agg/extreme_10c_5s":   json.loads(Path("artifacts/model_08c_maker_defense_v3_eventtime/extreme_10c_5s/agg_only/metrics.json").read_text()).get("auc_test"),
    "08c_v3_agg/severe_7c_3s":     json.loads(Path("artifacts/model_08c_maker_defense_v3_eventtime/severe_7c_3s/agg_only/metrics.json").read_text()).get("auc_test"),
    "08c_v3_agg/moderate_5c_5s":   json.loads(Path("artifacts/model_08c_maker_defense_v3_eventtime/moderate_5c_5s/agg_only/metrics.json").read_text()).get("auc_test"),
}

SPECS_49 = [
    ("08b", "artifacts/model_08b_big_move_classifier/tabular_btc/lightgbm/model.pkl", "big_move_02"),
    *[(f"08c_v1/{t}", f"artifacts/model_08c_maker_defense/{t}/model.pkl", t)
...
SPECS_58 = [
    *[(f"08c_v2/{t}", f"artifacts/model_08c_maker_defense_v2/{t}/model.pkl", t)
      for t in ["extreme_10c_5s", "severe_7c_3s", "moderate_5c_5s"]],
]

SPECS_AGG32 = [
    *[(f"08c_v3_agg/{t}", f"artifacts/model_08c_maker_defense_v3_eventtime/{t}/agg_only/model.pkl", t)
      for t in ["extreme_10c_5s", "severe_7c_3s", "moderate_5c_5s"]],
]
...
def main():
    ...
    # Save report
    out = Path("docs/oos_eval_08bc_report.md")
    import io as _io
    buf = _io.StringIO()
